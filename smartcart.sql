...
("DoubleCart", 760.00, 1000, "img2.png","Não deixe nada para trás com o DoubleCart. Desenvolvido para compras de grande volume ou abastecimento mensal, este modelo conta com dois níveis de armazenamento robustos. Apesar de sua capacidade superior, mantém a leveza no manuseio graças ao seu sistema de rodízios de alta performance. A solução perfeita para otimizar o transporte de múltiplos itens com total segurança."),
("SmartGlide", 490.00, 800, "img3.png","O SmartGlide redefine a praticidade. Com seu sistema de 'puxe' inteligente, ele é perfeito para compras rápidas e corredores mais estreitos. Sua alça telescópica ajustável se adapta à sua altura, garantindo conforto total. Leve, compacto e extremamente manobrável, o SmartGlide é a escolha certa para quem valoriza agilidade sem abrir mão do espaço interno."),
("SmartConfort ", 399.00, 50, "img4.png","Transforme as compras em família em um momento tranquilo com o SmartConfort. Equipado com uma cadeirinha de bebê integrada, segura e higiênica, este carrinho foi desenhado pensando na proteção dos pequenos e na conveniência dos pais. Estrutura estável e cesto acessível garantem que você possa focar no que precisa comprar, sabendo que seu filho está confortável e seguro."),
("SmartDrop", 180.00, 3000, "img5.png","Para aquelas visitas rápidas à loja, a SmartDrop é imbatível. Feita de material ultrarresistente e leve, possui alças anatômicas que não machucam as mãos, mesmo com peso. Design moderno que facilita o empilhamento e a limpeza, sendo a companheira ideal para quem precisa de velocidade e praticidade no dia a dia.");
